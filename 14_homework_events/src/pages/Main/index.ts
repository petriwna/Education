...
//
//   imgContainer.innerHTML = `<img srcппп="${json.url}" class="gallery__img"/>`
//   console.log(json)
//   return imgContainer;
// }
const featured: HTMLDivElement = document.querySelector('.featured-item');
...
function renderImage(json: any) {
  featured.innerHTML = `<img src="${json.url}" class="gallery__img"/>`
  console.log(json)
  return featured;
}
...
let galleryItems: NodeListOf<HTMLImageElement>;
